            ...
            <Introduce>
                <TextSection aria-labelledby="맥주의 역사">
                    ...
                    <Content aria-describedby="맥주의 역사 설명">
                        ...
                        정보를 알아내고 있습니다. 고대 이집트 당시 대형 양조장이
                        있었다고 합니다. <br />
                        현재 우리가 아는 맥주 제조방법은 독일에서 시작되었으며
                        독일로 여행을 가신다면 몇백년 된 양조장들을 구경할 수
                        있습니다. <br /> <br />
                        19세기 맥주에 큰 변화가 왔었습니다. 맥주의 대량 생산을
                        가능하게 해줬으며, 카를 폰 린데 독일인이 냉동기를
                        제작하여 계절에 상관없이 양조를 가능하게 했다. <br />
                        루이 파스퇴르 프랑스인이 술이 효모의 작용에 의해
                        생성된다는 사실과 열처리 살균법을 개발하여 오랫동안
                        보관이 가능하게 되었습니다. <br />
                        이후 에밀 한센 덴마크인이 파스퇴르의 이론을 응용해
                        효모의 순수배양법을 개발하면서 맥주의 품질을 높였습니다.{" "}
                        <br />
                        80년대 이후 맥주 고유의 신선도를 유지하면서 장기 유통을
                        할 수 있는 첨단 비열처리 공법이 개발되면서 소비자들은
                        더욱 신선한 맥주를 즐길 수 있게 되었습니다.
                    </Content>
                </TextSection>
                <TextSection aria-labelledby="취급 상식">
                    ...
                    <Content aria-describedby="취급 상식 설명">
                        ...
                        시원하게 드시려고 냉동실에 넣으면 병맥주가 터지니 절대
                        넣지 마십시오. <br />
